...
function App() {
  ...
  const handleAddMovie = () => {
    if (!newMovie.title || !newMovie.releaseYear || !newMovie.imdbID) {
      alert('Please fill in all fields.');
      return;
    }

    const releaseYear = parseInt(String(newMovie.releaseYear), 10);
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setNewMovie({ ...newMovie, [name]: updatedValue });
  };
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    value={String(newMovie.releaseYear)}
                    onChange={handleInputChange}
                  />
                </td>
                <td>
